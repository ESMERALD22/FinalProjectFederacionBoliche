<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            {{ Form::select('idEntrenador', $entrenadores ,$entrenadorCentroDeportivo->idEntrenador, ['class' => 'form-control' . ($errors->has('idEntrenador') ? ' is-invalid' : ''), 'placeholder' => 'Identrenador']) }}
        ...
        <div class="form-group">
            {{ Form::label('idFADN') }}
            {{ Form::select('idFADN', $fadns ,$entrenadorCentroDeportivo->idFADN, ['class' => 'form-control' . ($errors->has('idFADN') ? ' is-invalid' : ''), 'placeholder' => 'Idfadn']) }}
            {!! $errors->first('idFADN', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <div class="form-group">
            {{ Form::label('idNivelFADN') }}
            {{ Form::select('idNivelFADN', $nivelfadns ,$entrenadorCentroDeportivo->idNivelFADN, ['class' => 'form-control' . ($errors->has('idNivelFADN') ? ' is-invalid' : ''), 'placeholder' => 'Idnivelfadn']) }}
            {!! $errors->first('idNivelFADN', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <div class="form-group">
            {{ Form::label('idCentroDeportivo') }}
            {{ Form::select('idCentroDeportivo', $centrodeportivos ,$entrenadorCentroDeportivo->idCentroDeportivo, ['class' => 'form-control' . ($errors->has('idCentroDeportivo') ? ' is-invalid' : ''), 'placeholder' => 'Idcentrodeportivo']) }}
            {!! $errors->first('idCentroDeportivo', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <div class="form-group">
            {{ Form::label('idNivelCDAG') }}
            {{ Form::select('idNivelCDAG', $nivelcdags ,$entrenadorCentroDeportivo->idNivelCDAG, ['class' => 'form-control' . ($errors->has('idNivelCDAG') ? ' is-invalid' : ''), 'placeholder' => 'Idnivelcdag']) }}
            {!! $errors->first('idNivelCDAG', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <div class="form-group">
            {{ Form::label('idContrato') }}
            {{ Form::select('idContrato', $contratos  ,$entrenadorCentroDeportivo->idContrato, ['class' => 'form-control' . ($errors->has('idContrato') ? ' is-invalid' : ''), 'placeholder' => 'Idcontrato']) }}
