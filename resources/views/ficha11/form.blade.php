<div class="box box-info padding-1">
    ...
    <div class="box-body">
        ...
        <div class="form-group">
            {{ Form::label('GENERO') }}
            {{ Form::text('generoA', $ficha1->generoA, ['class' => 'form-control' . ($errors->has('generoA') ? ' is-invalid' : ''), 'placeholder' => 'Genero']) }}
            {!! $errors->first('generoA', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <div class="form-group">
            {{ Form::label('MUNICIPIO DE NACIMIENTO') }}
            {{ Form::text('idMunicipioA', $ficha1->idMunicipioA, ['class' => 'form-control' . ($errors->has('idMunicipioA') ? ' is-invalid' : ''), 'placeholder' => 'Municipio']) }}
        ...
        <div class="form-group">
            ...
            {{ Form::text('estadoCivilA',$ficha1->estadoCivilA, ['class' => 'form-control' . ($errors->has('estadoCivilA') ? ' is-invalid' : ''), 'placeholder' => 'Estado civil']) }}
        ...
        <div class="form-group">
            ...
            {{ Form::text('fotografiaA', $ficha1->fotografiaA, ['class' => 'form-control' . ($errors->has('fotografiaA') ? ' is-invalid' : ''), 'placeholder' => 'Fotografia']) }}
        ...
        <div class="form-group">
            {{ Form::label('CELULAR') }}
            {{ Form::number('celularE', $ficha1->celularE, ['class' => 'form-control' . ($errors->has('celularE') ? ' is-invalid' : ''), 'placeholder' => 'No. Celular']) }}
            {!! $errors->first('celularE', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <div class="form-group">
            {{ Form::label('GENERO') }}
            {{ Form::text('generoE', $ficha1->generoE, ['class' => 'form-control' . ($errors->has('generoE') ? ' is-invalid' : ''), 'placeholder' => 'Genero']) }}
